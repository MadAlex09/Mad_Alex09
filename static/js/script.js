...
function initProjectModal() {
    ...
    const projects = {
        booking: {
            index: "PROJECT / 01",
            title: "Система бронирования ПК-клуба",
            description:
                "Полноценный Telegram-бот для компьютерного клуба. Пользователь проходит регистрацию, выбирает зал, компьютер, дату, время и продолжительность игры. Система проверяет занятость и отправляет заявку администратору.",
            features: [
                "Регистрация пользователей",
                "Получение номера телефона",
                "Выбор общего или VIP-зала",
                "Выбор компьютера",
        ...
        website: {
            ...
            description:
                "Современный адаптивный сайт для презентации услуг разработчика. Сайт содержит анимации, портфолио, форму заявки, базу данных и серверную часть на Flask.",
            features: [
                "Адаптивный дизайн",
                "Неоновая стилистика",
                "Анимации появления",
        ...
        automation: {
            ...
            description:
                "Система автоматизации для объединения нескольких сервисов в единый рабочий процесс. Решение может получать данные по API, сохранять их в базе и отправлять результат в Telegram или веб-интерфейс.",
            features: [
