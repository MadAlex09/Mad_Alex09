...
function initProjectModal() {
    ...
    const projects = {
        booking: {
            ...
            description:
                "Демонстрационный проект Telegram-бота для компьютерного клуба. Пользователь проходит регистрацию, выбирает зал, компьютер, дату, время и продолжительность игры. Система проверяет занятость и формирует заявку для администратора.",
            features: [
